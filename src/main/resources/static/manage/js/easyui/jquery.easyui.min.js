...
var dlg=_2bf($.extend({},$.messager.defaults,{content:"<div style='text-align:center'><img width='50px' height='50px' src='js/easyui/themes/icons/loding.gif'/></div><div class=\"messager-progress\"><div class=\"messager-p-msg\">"+opts.msg+"</div><div class=\"messager-p-bar\"></div></div>",closable:false,doSize:false},opts,{onClose:function(){
if(this.timer){
